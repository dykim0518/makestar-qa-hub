...
- Tailwind CSS 4 + CSS custom properties (라이트 cool slate, 다크 전환 가능 구조)
...
- **UI 작업 시 `DESIGN.md` 참조 필수**: 색·타이포·컴포넌트·spacing·responsive 9개 섹션 정의. 새 페이지·컴포넌트 만들 때 §9 Agent Prompt Guide의 패턴 그대로 적용.
