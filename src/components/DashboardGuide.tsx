          ...
          <div className="px-4 pb-4 pt-3">
            ...
            <div className="mt-3 rounded-lg border border-[var(--card-border)] bg-slate-50 px-3 py-2.5">
              ...
              <ul className="space-y-1 text-[11px] text-[var(--muted)]">
                <li>
                  • 테스트 실행 중에는{" "}
                  <strong className="text-slate-700">5초마다</strong> 자동 갱신,
                  유휴 시 <strong className="text-slate-700">30초</strong> 간격
                </li>
                <li>
                  • 탭 전환 후 복귀하면{" "}
                  <strong className="text-slate-700">즉시 데이터 갱신</strong>
                </li>
                <li>
                  • 히스토리에서{" "}
                  <strong className="text-slate-700">2개 Run 선택</strong> →
                  비교 분석 가능
                </li>
              </ul>
            </div>
