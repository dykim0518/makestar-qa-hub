        ...
        <div className="mb-3 w-[360px] max-h-[70vh] overflow-y-auto rounded-xl border border-[var(--card-border)] bg-[var(--card)] shadow-2xl shadow-black/40">
          ...
          <div className="px-4 pb-4 pt-3">
            ...
            <div className="mb-4 flex flex-wrap items-center justify-center gap-1 text-[10px] font-semibold">
              <span className="rounded-md bg-indigo-500/15 px-2 py-1 text-indigo-300">필터</span>
              <span className="text-[var(--muted)]">→</span>
              <span className="rounded-md bg-emerald-500/15 px-2 py-1 text-emerald-300">요약</span>
              <span className="text-[var(--muted)]">→</span>
              <span className="rounded-md bg-blue-500/15 px-2 py-1 text-blue-300">트렌드</span>
              <span className="text-[var(--muted)]">→</span>
              <span className="rounded-md bg-amber-500/15 px-2 py-1 text-amber-300">Flaky</span>
              <span className="text-[var(--muted)]">→</span>
              <span className="rounded-md bg-purple-500/15 px-2 py-1 text-purple-300">히스토리</span>
            </div>
            ...
            <div className="mt-3 rounded-lg border border-[var(--card-border)] bg-white/[0.02] px-3 py-2.5">
              ...
              <ul className="space-y-1 text-[11px] text-[var(--muted)]">
                <li>• 테스트 실행 중에는 <strong className="text-white/80">5초마다</strong> 자동 갱신, 유휴 시 <strong className="text-white/80">30초</strong> 간격</li>
                <li>• 탭 전환 후 복귀하면 <strong className="text-white/80">즉시 데이터 갱신</strong></li>
                <li>• 히스토리에서 <strong className="text-white/80">2개 Run 선택</strong> → 비교 분석 가능</li>
              </ul>
            </div>
          </div>
        </div>
